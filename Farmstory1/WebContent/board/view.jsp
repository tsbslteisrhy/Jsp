...
<section id="board" class="view">
    ...
    <table>
        ...
        <tr>
            <td>첨부파일</td>
            <td>
                <a href="/Farmstory1/board/proc/download.jsp?seq=<%= fBean.getSeq() %>&group=<%= group %>&cate=<%= cate %>"><%=fileBean.getOldName() %></a>
    ...
    <div>
         <a href="../board/proc/delete.jsp?seq=<%= seq %>&group=<%= group %>&cate=<%= cate %>" onclick="return onDelete()" class="btnDelete">삭제</a>
         <a href="./modify.jsp?seq=<%= seq %>&group=<%= group %>&cate=<%= cate %>" class="btnModify">수정</a>
    ...
    <section class="commentList">
        ...
        <article class="comment">
            ...
            <div>
                <a href="/Farmstory1/board/proc/deleteComment.jsp?seq=<%= comment.getSeq() %>&group=<%= group %>&cate=<%= cate %>&parent=<%= comment.getParent() %>">삭제</a>
                <a href="#">수정</a>
            </div>
            <% } %>
        </article>
