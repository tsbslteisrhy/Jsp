...
<main>
    <div class="slider">
        ...
        <ul>
            <li><img src="./img/main_slide_img1.jpg" alt="slider1"/></li>
            <li><img src="./img/main_slide_img2.jpg" alt="slider2"/></li>
            <li><img src="./img/main_slide_img3.jpg" alt="slider3"/></li>
        </ul>
    ...
    <div class="info">
        <div class="cs">
            ...
            <div>
                <img src="./img/main_sub2_cs_img.png" alt="dlalwl"/>
        ...
        <div class="account">
            ...
            <ul>
                <li>기업은행 123-45789-01-01-012</li>
                <li>국민은행 01-1234-56789</li>
                <li>우리은행 123-45789-01-01-012</li>
